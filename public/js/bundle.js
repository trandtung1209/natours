...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHJhbmR0dW5nMTIwOSIsImEiOiJja2p5OTd3NmgwMHdrMm5tdDRkNmw3dHg1In0.8VqwKz5dwEJi29J8qqTBtA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/trandtung1209/ckjz1oy9w04i517qw6fd8bhd4',
    scrollZoom: false,
    doubleClickZoom: false,
    boxZoom: false // center: [-118.113491, 34.111745],
    // zoom: 10,
    // interactive: false,
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alerts.showAlert)('success', 'Log in successfully!');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IAsVnEhSQ6TMuhrT0uJWvNPmGmJeBmC7pNIPbgPR1185dBbKnHyE5hyH1mBrrCFqMdfaABqtJiIhlABB9HeJw2H00tB7XaIdj'); //checkout session from API
